...
#define MAX_MESSAGE_HANDLERS 100 /* redefinable - how many subscriptions do you want? */
#endif
...
DLLExport void MQTTClientInit_defaultMessage(MQTTClient* client, messageHandler);
 ...
 *  @return success code
 */
 /*Begin: modify by yjj in 2018.05.10 for support fix multi-defined with aliyun*/
//#ifdef FEATURE_NWY_PAHO_MQTT
//DLLExport int MQTTConnect(MQTTClient* client, MQTTPacket_connectData* options);
DLLExport int nwy_MQTTConnect(MQTTClient* client, MQTTPacket_connectData* options);
//#endif
/*End: modify by yjj in 2018.05.10 for support fix multi-defined with aliyun*/
...
DLLExport int nwy_MQTTPublish(MQTTClient* client, const char*, MQTTMessage*);
//#endif
/*End: modify by yjj in 2018.05.10 for support fix multi-defined with aliyun*/
